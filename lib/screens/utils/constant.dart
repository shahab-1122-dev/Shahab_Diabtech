...
// /// All app-wide constants, colors, text styles, and buttons
...
// class AppColors {
//  static const Color primary = Color(0xFF00A86B); // Green accent
//   static const Color secondary = Color(0xFF1C1C1C); // Dark text
//   static const Color background = Color(0xFFF9F9F9); // Light background
//   static const Color card = Color(0xFFFFFFFF); // White cards
//   static const Color accent = Color(0xFFFFC107); // Yellow highlights
